...
parser.add_argument('--penalty_anneal_iters', type=int, default=20)
...
parser.add_argument(
    '--dataset_path',
    type=str,
    default='/home/qyr/Certified_Robustness_Defense_CelebA/CelebA/img_align_celeba',
    help='Path to the CelebA image root directory'
)
...
env1 = unpickle('train_env1_smile.pickle')
env2 = unpickle('train_env2_smile.pickle')
